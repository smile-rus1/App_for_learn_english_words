    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        :attr:`_asyncio.AsyncEngine.sync_engine` attribute::
            ...
            engines = {
                'leader':create_async_engine("sqlite+aiosqlite:///leader.data_base"),
                'other':create_async_engine("sqlite+aiosqlite:///other.data_base"),
                'follower1':create_async_engine("sqlite+aiosqlite:///follower1.data_base"),
                'follower2':create_async_engine("sqlite+aiosqlite:///follower2.data_base"),
            }
