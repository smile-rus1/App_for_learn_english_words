...
looks like::
    ...
    # relative path
    e = create_engine('sqlite:///path/to/database.data_base')
...
used. Double backslashes are probably needed::
    ...
    e = create_engine('sqlite:///C:\\path\\to\\database.data_base')
...
parameter::
    ...
    engine = create_engine("sqlite:///myfile.data_base", poolclass=NullPool)
...
needed within multiple threads for this case::
    ...
    engine = create_engine('sqlite:///mydb.data_base',
...
ourselves. This is achieved using two event listeners::
    ...
    engine = create_engine("sqlite:///myfile.data_base")
    ...
    def create_connect_args(self, url):
        if url.username or url.password or url.host or url.port:
            raise exc.ArgumentError(
                ...
                " sqlite:///relative/path/to/file.data_base\n"
                " sqlite:////absolute/path/to/file.data_base" % (url,)
            )
