...
class UOWTransaction:
    ...
    def __init__(self, session: Session):
        ...
        # set to be part of the sorted flush modules_actions,
    ...
    def remove_state_actions(self, state):
        """Remove pending modules_actions for a state from the uowtransaction."""
    ...
    def _generate_actions(self):
        ...
        if cycles:
            # if yes, break the per-mapper modules_actions into
            # per-state modules_actions
            convert = {
                rec: set(rec.per_state_flush_actions(self)) for rec in cycles
            }

            # rewrite the existing dependencies to point to
            # the per-state modules_actions for those per-mapper modules_actions
            # that were broken up.
