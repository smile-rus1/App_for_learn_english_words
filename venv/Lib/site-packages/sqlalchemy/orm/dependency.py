...
class DependencyProcessor:
    ...
    def per_property_preprocessors(self, uow):
        """establish modules_actions and dependencies related to a flush.

        These modules_actions will operate on all relevant states in
        the aggregate.
    ...
    def per_state_flush_actions(self, uow, states, isdelete):
        ...
        These modules_actions will operate on all relevant states
        ...
        if child_saves not in uow.cycles:
            ...
            # modules_actions to the aggregate "saves", "deletes" modules_actions
        ...
        # now create modules_actions /dependencies for each state.
