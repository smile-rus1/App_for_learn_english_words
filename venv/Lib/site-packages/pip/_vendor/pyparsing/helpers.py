...
def infix_notation(
    ...
    or binary, left- or right-associative.  Parse modules_actions can also be
    ...
    prints::
        ...
        [[['-', 2], '-', ['-', 11]]]
    """
    # captive version of FollowedBy that does not do parse modules_actions or capture results names
...
def indentedBlock(blockStatementExpr, indentStack, indent=True, backup_stacks=[]):
    ...
    (Note that indentedBlock uses internal parse modules_actions which make it
